...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{asset("public/frontend/images/images/ico/apple-touch-icon-57-precomposed.png")}}">
</head><!--/head-->
...
<body>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								?>
								<li><a href="{{URL::to('/payment')}}"><i class="fa fa-search"></i> Thanh toán</a></li>
								<?php
								}else{
								?>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">No Copyright © 2013 Inc. All rights reserved.</p>
				</div>
			</div>
		</div>
